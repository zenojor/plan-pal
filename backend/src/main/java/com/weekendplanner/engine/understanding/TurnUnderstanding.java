...
public record TurnUnderstanding(
    ...
    public static TurnUnderstanding empty() {
        return new TurnUnderstanding(TurnIntent.UNKNOWN, DomainIntent.UNKNOWN, Map.of(), List.of(),
    ...
    public static class Builder {
        ...
        public TurnUnderstanding build() {
            return new TurnUnderstanding(turnIntent, domainIntent, slots, missingSlots, readOnlyQuestion,
